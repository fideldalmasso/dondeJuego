...
import paneles.PanelMisCompetencias.Trabajador3;
...
public class PanelVerCompetencia extends PanelPersonalizado {
	...
	MyIcon iconocargando;
	JLabel nombre;
	JLabel modalidad;
	JLabel deporte;
	JLabel estado;
	JButton botonverparticipantes;
	...
	public PanelVerCompetencia(App padre, int idCompetencia, PanelVerCompetenciaConMensajes capas) {
		...
		iconocargando = new MyIcon("icon/loading3.gif", 30, 30, true);
		...
		botonverparticipantes = new JButton("Ver participantes");
...
//		});
	...
	public void ejecutarTrabajador2() {
		PanelVerCompetencia.Trabajador2 t  = this.new Trabajador2();
		t.execute();
	}

	class Trabajador2 extends SwingWorker<VerCompetenciaDTO, Void>{

		private VerCompetenciaDTO t;
		@Override
		protected VerCompetenciaDTO doInBackground() throws Exception {
			PanelVerCompetencia.this.gestorCompetencia = new GestorCompetencia();
			t= PanelVerCompetencia.this.gestorCompetencia.getCompetenciaDTO(idCompetencia);
			PanelVerCompetencia.this.dto = t;
			return t;
		}
		@Override 
		protected void done() {
			...
			//				return;
			//			}
			PanelVerCompetencia.this.nombreCompetencia = t.getNombre();
			PanelVerCompetencia.this.botonverparticipantes.setEnabled(true);
			PanelVerCompetencia.this.nombre.setText(t.getNombre());
			PanelVerCompetencia.this.modalidad.setText(t.getModalidad());
			PanelVerCompetencia.this.deporte.setText(t.getDeporte());
			PanelVerCompetencia.this.estado.setText(t.getEstado());
			...
			PanelVerCompetencia.this.tabla1.setModel(new PanelVerCompetenciaTM1(t));
			PanelVerCompetencia.this.tabla2.setModel(new PanelVerCompetenciaTM2(t));
			PanelVerCompetencia.this.tabla2.setJTableColumnsWidth(31,31,7,31);
			PanelVerCompetencia.this.iconocargando.setVisible(false);
		}
